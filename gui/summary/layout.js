var getScorePanelsData = () => ({
  score: {
    ...
    headings: [
      ...
      },
      {
        ...
        caption: translate("Total score"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "economyScore",
        caption: translate("Economy score"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "militaryScore",
        caption: translate("Military score"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "explorationScore",
        caption: translate("Exploration score"),
        yStart: 16,
        width: 100
      }
    ],
  ...
  buildings: {
    ...
    headings: [
      ...
      {
        identifier: "House",
        caption: translate("Houses"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Economic",
        caption: translate("Economic"),
        yStart: 34,
        width: 85
      },
      {
      ...
      {
        identifier: "Military",
        caption: translate("Military"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Fortress",
        caption: translate("Fortresses"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "CivCentre",
        caption: translate("Civ centers"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Wonder",
        caption: translate("Wonders"),
        yStart: 34,
        width: 85
      }
    ],
    titleHeadings: [
      {
        caption: sprintf(
          translate(
            "Buildings Statistics (%(constructed)s / %(destroyed)s / %(captured)s / %(lost)s)"
          ),
          {
  ...
  units: {
    ...
    headings: [
      ...
      {
        identifier: "Infantry",
        caption: translate("Infantry"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Worker",
        caption: translate("Worker"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Cavalry",
        caption: translate("Cavalry"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Champion",
        caption: translate("Champion"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Hero",
        caption: translate("Heroes"),
        yStart: 34,
        width: 85
      },
      {
        identifier: "Siege",
        caption: translate("Siege"),
        yStart: 34,
        width: 85
      },
    ...
    titleHeadings: [
      {
        caption: sprintf(
          translate(
            "Units Statistics (%(trained)s / %(killed)s / %(captured)s / %(lost)s)"
          ),
          {
  ...
  resources: {
    ...
    headings: [
      ...
      {
        identifier: "treasuresCollected",
        caption: translate("Treasures collected"),
        yStart: 16,
        width: 85
      },
      { identifier: "loot", caption: translate("Loot"), yStart: 16, width: 85 },
      {
        identifier: "livestock",
        caption: translate("Livestock bred"),
        yStart: 16,
        width: 85
      }
    ],
    titleHeadings: [
      {
        caption: sprintf(
          translate("Resource Statistics (%(gathered)s / %(used)s)"),
          {
  ...
  market: {
    ...
    headings: [
      ...
      {
        identifier: "tradeIncome",
        caption: translate("Trade income"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "barterEfficency",
        caption: translate("Barter efficiency"),
        yStart: 16,
        width: 100
      },
      ...g_ResourceData.GetResources().map(res => {
  ...
  misc: {
    ...
    headings: [
      ...
      {
        identifier: "killDeath",
        caption: translate("Kill / Death ratio"),
        yStart: 16,
        width: 100,
        format: "DECIMAL2"
      },
      {
        identifier: "mapControlPeak",
        caption: translate("Map control (peak)"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "mapControl",
        caption: translate("Map control (finish)"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "mapExploration",
        caption: translate("Map exploration"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "vegetarianRatio",
        caption: translate("Vegetarian ratio"),
        yStart: 16,
        width: 100
      },
      {
        identifier: "feminization",
        caption: translate("Feminization"),
        yStart: 16,
        width: 100
      },
      {
...
function updateGeneralPanelHeadings(headings) {
  ...
  for (let h in headings) {
    ...
    if (h > 0) headerGUIName = "Heading[" + (h - 1) + "]";
    ...
    if (headings[h].width < g_LongHeadingWidth) left += headings[h].width;
  }
}
...
function updateGeneralPanelTitles(titleHeadings) {
  ...
  for (let th in titleHeadings) {
    if (th >= g_MaxHeadingTitle) break;

    if (titleHeadings[th].xOffset) left += titleHeadings[th].xOffset;
...
function updateGeneralPanelCounter(counters) {
  ...
  for (let p = 0; p < g_MaxPlayers; ++p) {
    ...
    for (let w in counters) {
      counterObject = Engine.GetGUIObjectByName(
        "valueData[" + p + "][" + w + "]"
      );
      counterObject.size =
        left +
        " " +
        counters[w].verticalOffset +
        " " +
    ...
    if (rowPlayerObjectWidth == 0) rowPlayerObjectWidth = left;
    ...
    for (let t = 0; t < g_MaxTeams; ++t) {
      ...
      for (let w in counters) {
        ...
        if (g_Teams[t]) {
          let yStart =
            25 +
            g_Teams[t].length * (g_PlayerBoxYSize + g_PlayerBoxGap) +
            3 +
            counters[w].verticalOffset;
          counterTotalObject = Engine.GetGUIObjectByName(
            "valueDataTeam[" + t + "][" + w + "]"
          );
          counterTotalObject.size =
            left +
            20 +
            " " +
            yStart +
...
function updateGeneralPanelTeams() {
  ...
  let yStart =
    g_TeamsBoxYStart +
    withoutTeam * (g_PlayerBoxYSize + g_PlayerBoxGap) +
    (withoutTeam ? 30 : 0);
  for (let i in g_Teams) {
    ...
    Engine.GetGUIObjectByName("teamNameHeadingt[" + i + "]").caption =
      "Team " + (+i + 1);

    let teamHeading = Engine.GetGUIObjectByName("teamHeadingt[" + i + "]");
    let yStartTotal =
      30 + g_Teams[i].length * (g_PlayerBoxYSize + g_PlayerBoxGap) + 10;
  ...
  if (!withoutTeam) Engine.GetGUIObjectByName("playerNameHeading").caption = "";
}
...
function initPlayerBoxPositions() {
  for (let h = 0; h < g_MaxPlayers; ++h) {
    ...
    for (let i = 0; i < g_MaxTeams; ++i) {
      let playerBoxt = Engine.GetGUIObjectByName(
        "playerBoxt[" + i + "][" + h + "]"
      );
