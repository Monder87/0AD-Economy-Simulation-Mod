...
Identity.prototype.Schema =
  ...
  "</element>" +
  "<optional>" +
  "<element name='CityName' a:help='the actual name of the city.'>" +
  "<text/>" +
  "</element>" +
  "</optional>" +
  "<optional>" +
...
Identity.prototype.Init = function() {
  ...
  // we give a name to each City for each Civ
...
Identity.prototype.GetCityName = function() {
  if (this.template.CityName) {
    return this.CityName;
  }
};

Identity.prototype.GenerateCityName = function() {
  let civ = this.GetCiv();
  let cmpCityNameGenerator = Engine.QueryInterface(
    SYSTEM_ENTITY,
